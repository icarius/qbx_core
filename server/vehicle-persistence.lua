...
--- Resolves netId to a vehicle only if the requesting player is actually seated in it,
--- so a client can't drive persistence writes for a vehicle it doesn't occupy.
---@param source number
---@param netId unknown
---@return number?
